  ...
  return (
    <div className="relative">
      <div className="relative">
        ...
        <div
          id="drawer"
          className={`fixed h-full sm:w-96 w-screen left-0 top-0 bg-white z-20 px-5 overflow-y-auto pb-[60px] transform transition-transform duration-300 ${
          ...
          <div className="space-y-[30px]">
            {!subMenuVisible && !langMenuVisible && (
              <div className="space-y-[30px]">
                ...
                <ul className="font-bold">
                  <li>
                    <div className="py-[15px] px-[5px] text-red-600 uppercase">
                      <Link to={"/"}>Home</Link>
                    </div>
                  </li>
                  <li>
                    <button
                      onClick={handleClick}
                      className="py-[15px] px-[5px] flex justify-between text-gray-600 uppercase items-center w-full"
                    >
                      News
                      <svg
                        viewBox="0 0 15 15"
            ...
            {langMenuVisible && (
              <div className="space-y-[30px] text-gray-600 font-bold text-sm">
                <button
                  className="uppercase flex items-center font-bold text-sm py-[15px] text-gray-600"
                  onClick={() => setLangMenuVisible(false)}
                >
                  <svg
                    viewBox="0 0 15 15"
                    fill="none"
            ...
            <div className="py-5 border-t border-gray-300">
              ...
              <div className="mt-5">
                <ul className="grid grid-cols-12 text-sm">
                  <li className="font-bold col-span-full sm:col-span-3 w-fit">
                    HELP
                  </li>
                  <li className="col-span-full sm:col-span-3 w-fit">
                    Help & FAQs
                  </li>
        ...
        <nav className="flex justify-between bg-liverRed p-3">
          <button onClick={() => setMenuVisible(!menuVisible)}>
            ...
            >
              <path
                fill="#fff"
                d="M0 0h20v2H0V0zM0 12h20v2H0v-2zM0 6h20v2H0V6z"
              ></path>
            </svg>
          </button>
