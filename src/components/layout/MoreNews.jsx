    ...
    <div className='px-4 sm:px-0'>
        <div className='flex flex-col items-center w-full'>
            <div className='space-y-8'>
                ...
                <div className='space-y-10 hover:bg-black hover:bg-opacity-10 transition ease-in duration-200 sm:w-[50rem] p-3'>
                    <div>
                        <h3 className='flex gap-2 sm:text-4xl text-wrap items-center'>
                    ...
                    <div>
                        <img src={lfcDiary} alt="" className='sm:w-[50rem]' />
                    </div>
                </div>
            </div>
        </div>
