      ...
      <main className="mt-32">
        <div className="pb-[90px] px-[60px] grid grid-cols-12">
          ...
          <div className="sm:col-span-8 col-span-full">
            <HeadlinePost dark={true} Image={bigImg} time={new Date("2024-08-04")} title="Gallery" text="Photos: Six Liverpool players begin pre-season training. Six players returned to Liverpool’s AXA Training Centre on Sunday to begin pre-season training." />
          </div>
          <div className="sm:col-span-4 col-span-full">
            <HeadlinePost dark={true} />
          </div>
          ...
          <div className="col-span-full pt-[90px] pb-[120px] flex justify-center">
            <button className='text-white flex items-center px-5 pb-4 bg-black w-full max-w-xs h-16 hover:bg-opacity-60'>
                LOAD MORE
